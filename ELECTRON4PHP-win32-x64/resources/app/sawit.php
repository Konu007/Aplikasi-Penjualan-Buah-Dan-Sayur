...
<html>
	<head>
		<title>Data Buah Dan Sayur</title>
		<meta charset="utf-8">
			...
			<div class='row' style='min-height:520px'>
				<div class='col-md-12'>
					...
					<div class='panel panel-info'>
						<div class='panel-heading'>Semua Data Buah Dan Sayur</div>
						<div class='panel-body'>
							<a class='btn btn-info' href='add_sawit.php'><i class='fa fa-plus'></i> Tambah Data Buah/Sayur</a>
							<p>
							<table class="table table-hover table-bordered">
							  <thead>
								<tr>
								  <th>Kode Buah/Sayur</th>
								  <th>Nama Buah/Sayur</th>
								  <th>Harga Jual</th>
								  <th>Potongan</th>
								  <th>Aksi</th>
								</tr>
